    ...
    objections: [
      {
        ...
        content: "Perfeito. Foi pra isso que criamos esse método: sem teoria, sem enrolação. Execução direta."
      },
      {
        title: "❌ Qual o resultado REAL disso?",
        content: "Liberdade operacional e aumento de lucro em até 90 dias."
      },
      {
        title: "❌ Quanto tempo até ver dinheiro no bolso?",
        content: "Em até 30 dias, com aplicação real, o caixa começa a destravar."
      }
    ]
  },
  I: {
    ...
    objections: [
      { title: "❌ Não sei se é pra mim…", content: "Você não entra pronto, entra cansado. Aqui ganha clareza." },
      { title: "❌ Vou ter ajuda real?", content: "Acompanhamento real, grupo ativo e suporte de verdade." }
    ]
  },
  S: {
    ...
    response: "🛠 O programa acompanha seu ritmo, com estrutura clara.",
    objections: [
      { title: "❌ Medo de não manter", content: "Vamos passo a passo. Um plano leve e funcional." },
      { title: "❌ Agora é um bom momento?", content: "Se você chegou até aqui, já está na hora certa." }
    ]
  },
  C: {
    ...
    response: "🛠 Temos métricas claras e estudos de caso validados.",
    objections: [
      { title: "❌ Como funciona o processo?", content: "Diagnóstico, plano, implementação e checkpoints." },
      { title: "❌ Comprovação de que dá certo?", content: "Cases, prints de resultados e benchmarks." }
    ]
  }
};
